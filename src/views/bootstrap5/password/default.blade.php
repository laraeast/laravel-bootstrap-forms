...
<div class="mb-3">
    ...
    <div class="input-group input-group-merge">
        ...
        <!-- Eye (show password) -->
        <svg class="hide-icon" style="display: none" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
        ...
        <svg class="show-icon" style="display: inline" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
