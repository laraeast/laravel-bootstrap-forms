<div class="mb-3">
    ...
    <div class="image-preview"
         style="display:flex;gap: 1.5rem;align-items: center;padding-bottom: 1.5rem;min-width: 270px;">
        <img
        ...
        <div class="button-wrapper">
            ...
            @if($downloadLink)
                <small class="text-muted d-block">
                    <a href="{{ $downloadLink }}" style="text-decoration: none;display: flex;align-items: center;" target="_blank" download>
                        ...
                        <span style="margin-left: .5rem;">{{ __('BsForm::attachment.download') }}</span>
                    </a>
                </small>
            @endif
        </div>
