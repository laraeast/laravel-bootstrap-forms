<div class="form-group{{ $errors->{$errorBag}->has($nameWithoutBrackets) ? ' has-error' : '' }}">
    ...
    <div class="input-group">
        ...
        <span class="input-group-addon" onclick="
            ...
            <!-- Eye (show password) -->
            <svg class="hide-icon" style="display: none" width="18" height="18" fill="currentColor"
                 viewBox="0 0 24 24">
        ...
        <!-- Eye-slash (hide password) -->
            <svg class="show-icon" style="display: inline" width="18" height="18" fill="currentColor"
                 viewBox="0 0 24 24">
