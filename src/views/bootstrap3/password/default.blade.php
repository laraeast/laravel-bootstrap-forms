<div class="form-group{{ $errors->{$errorBag}->has($nameWithoutBrackets) ? ' has-error' : '' }}">
    ...
    <div class="input-group">
        ...
        <span class="input-group-addon" onclick="
            ...
            <svg class="hide-icon{{ $errors->{$errorBag}->has($nameWithoutBrackets) ? ' text-danger' : '' }}" style="display: none" width="18" height="18" fill="currentColor"
                 viewBox="0 0 24 24">
            ...
            <svg class="show-icon{{ $errors->{$errorBag}->has($nameWithoutBrackets) ? ' text-danger' : '' }}" style="display: inline" width="18" height="18" fill="currentColor"
                 viewBox="0 0 24 24">
